...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex h-9 w-9 items-center justify-center rounded-full border border-border/40 bg-background/50 hover:bg-accent hover:text-accent-foreground transition-all shadow-sm group"
